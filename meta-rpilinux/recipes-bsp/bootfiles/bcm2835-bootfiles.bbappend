...
do_after_deploy() {
    ...
    rm -f ${DEPLOY_DIR_IMAGE}/${BCM2711_DIR}/config.txt
    ...
    echo 'dtoverlay=pps-gpio,gpiopin=4' >> ${DEPLOY_DIR_IMAGE}/${BCM2711_DIR}/config.txt

    # Make a cmdline.txt
    # See https://madaidans-insecurities.github.io/guides/linux-hardening.html
    rm -f ${DEPLOY_DIR_IMAGE}/${BCM2711_DIR}/cmdline.txt
